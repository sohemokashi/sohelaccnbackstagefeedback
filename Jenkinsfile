...
repository="docker-registry.mtk8s.io/voyagers/sohelaccnbackstagefeedback"
RepositoryName="sohelaccnbackstagefeedback"
...
ENTITY_NAME = "sohelaccnbackstagefeedback"
